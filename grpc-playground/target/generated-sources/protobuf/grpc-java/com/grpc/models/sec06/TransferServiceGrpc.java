...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.models.sec06.TransferRequest,
      com.grpc.models.sec06.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Transfer",
      requestType = com.grpc.models.sec06.TransferRequest.class,
      responseType = com.grpc.models.sec06.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.grpc.models.sec06.TransferRequest,
      com.grpc.models.sec06.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.grpc.models.sec06.TransferRequest, com.grpc.models.sec06.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.grpc.models.sec06.TransferRequest, com.grpc.models.sec06.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.sec06.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.sec06.TransferResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.grpc.models.sec06.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.grpc.models.sec06.TransferResponse> responseObserver) {
  ...
  public static final class TransferServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.grpc.models.sec06.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.grpc.models.sec06.TransferResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.grpc.models.sec06.TransferRequest,
              com.grpc.models.sec06.TransferResponse>(
