...
@javax.annotation.Generated(
    ...
    comments = "Source: sec11/bank-service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class BankServiceGrpc {

  private BankServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "sec11.BankService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.grpc.models.sec11.BalanceCheckRequest,
      com.grpc.models.sec11.AccountBalance> getGetAccountBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBalance",
      requestType = com.grpc.models.sec11.BalanceCheckRequest.class,
      responseType = com.grpc.models.sec11.AccountBalance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.models.sec11.BalanceCheckRequest,
      com.grpc.models.sec11.AccountBalance> getGetAccountBalanceMethod() {
    io.grpc.MethodDescriptor<com.grpc.models.sec11.BalanceCheckRequest, com.grpc.models.sec11.AccountBalance> getGetAccountBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetAccountBalanceMethod = BankServiceGrpc.getGetAccountBalanceMethod) == null) {
          BankServiceGrpc.getGetAccountBalanceMethod = getGetAccountBalanceMethod =
              io.grpc.MethodDescriptor.<com.grpc.models.sec11.BalanceCheckRequest, com.grpc.models.sec11.AccountBalance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.sec11.BalanceCheckRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.models.sec11.WithDrawRequest,
      com.grpc.models.sec11.Money> getWithDrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WithDraw",
      requestType = com.grpc.models.sec11.WithDrawRequest.class,
      responseType = com.grpc.models.sec11.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.grpc.models.sec11.WithDrawRequest,
      com.grpc.models.sec11.Money> getWithDrawMethod() {
    io.grpc.MethodDescriptor<com.grpc.models.sec11.WithDrawRequest, com.grpc.models.sec11.Money> getWithDrawMethod;
    if ((getWithDrawMethod = BankServiceGrpc.getWithDrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithDrawMethod = BankServiceGrpc.getWithDrawMethod) == null) {
          BankServiceGrpc.getWithDrawMethod = getWithDrawMethod =
              io.grpc.MethodDescriptor.<com.grpc.models.sec11.WithDrawRequest, com.grpc.models.sec11.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WithDraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.sec11.WithDrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.sec11.Money.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getAccountBalance(com.grpc.models.sec11.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.grpc.models.sec11.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    default void withDraw(com.grpc.models.sec11.WithDrawRequest request,
        io.grpc.stub.StreamObserver<com.grpc.models.sec11.Money> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getAccountBalance(com.grpc.models.sec11.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.grpc.models.sec11.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    public void withDraw(com.grpc.models.sec11.WithDrawRequest request,
        io.grpc.stub.StreamObserver<com.grpc.models.sec11.Money> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.grpc.models.sec11.AccountBalance getAccountBalance(com.grpc.models.sec11.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.grpc.models.sec11.Money> withDraw(
        com.grpc.models.sec11.WithDrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.models.sec11.AccountBalance> getAccountBalance(
        com.grpc.models.sec11.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BALANCE:
          serviceImpl.getAccountBalance((com.grpc.models.sec11.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.models.sec11.AccountBalance>) responseObserver);
          break;
        case METHODID_WITH_DRAW:
          serviceImpl.withDraw((com.grpc.models.sec11.WithDrawRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.models.sec11.Money>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.grpc.models.sec11.BalanceCheckRequest,
              com.grpc.models.sec11.AccountBalance>(
                service, METHODID_GET_ACCOUNT_BALANCE)))
        .addMethod(
          getWithDrawMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.grpc.models.sec11.WithDrawRequest,
              com.grpc.models.sec11.Money>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.models.sec11.BankServiceUnary.getDescriptor();
    }
